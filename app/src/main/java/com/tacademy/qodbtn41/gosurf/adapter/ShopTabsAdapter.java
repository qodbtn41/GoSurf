 ...
 * 샵 탭의 어댑터
 */
public class ShopTabsAdapter extends FragmentPagerAdapter implements
    ...
    public ShopTabsAdapter(FragmentActivity activity, TabHost tabHost,
                           ViewPager pager) {
        this(activity,activity.getSupportFragmentManager(),tabHost,pager);
    }

    public ShopTabsAdapter(Context context, FragmentManager fragmentManager, TabHost tabHost, ViewPager pager) {
